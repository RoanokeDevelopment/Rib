...
class ReleasePokemonQuest(name: String = "Release Pokemon Quest",
    ...
    companion object : Quest.QuestFactory {
        override fun fromState(json: JsonObject, state: JsonObject, provider: QuestProvider, group: QuestGroup): Quest {
            val name = json.get("name").asString ?: "Default Release Pokemon Quest Title"
            ...
            return ReleasePokemonQuest(name, id, provider, group, pokeMatch, taskMessage, amount, progress).apply {
                rewards = rRewards;
